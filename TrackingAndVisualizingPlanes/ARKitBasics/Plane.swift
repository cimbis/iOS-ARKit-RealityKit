...
class Plane: SCNNode {
    ...
    init(anchor: ARPlaneAnchor, in sceneView: ARSCNView) {
            ...
            #error("ARKit is not supported in iOS Simulator. \nConnect a physical iOS device and select \nit as your Xcode run destination, or select \nGeneric iOS Device as a build-only destination.")
        #else
